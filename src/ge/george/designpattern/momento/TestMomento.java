...
public class TestMomento extends JFrame{
    ...
    class ButtonListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if(e.getSource() == saveBut){
                ...
                caretaker.addMemory( originator.storeInMemory() );
            ...
            if(e.getSource() == undoBut){
                ...
                if(currentArticle >= 1){
                    ...
                    String textBoxString = originator.restoreFromMemory( caretaker.getMemory(currentArticle) );
